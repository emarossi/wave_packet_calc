...
The attosecond XFEL pulse is approximated as a gaussian pulse, with the following parameters being fully regulable: pulse irradiance, central frequency, bandwdith/duration, polarization, time-delay. Both one-color and two-color pulses are available.
